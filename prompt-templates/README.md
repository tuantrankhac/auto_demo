...
2. Thay các placeholder `{URL}`, `{ModuleName}`, `{TestCaseID}`... bằng giá trị thật.
...
| 05 | [`prompt_05_generate_testscript.txt`](prompt_05_generate_testscript.txt) | Sinh Automation cho một testcase cụ thể | `/generate_testscript` |
| 06 | [`prompt_06_generate_module.txt`](prompt_06_generate_module.txt) | Sinh Automation end-to-end cho cả module (Automation=Yes) | `/manual_to_auto` |
